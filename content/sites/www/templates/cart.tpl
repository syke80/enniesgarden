...
<div class="total">
	<span><% $total|number_format:0:'':' ' %> Ft</span>
</div>

<div class="action">
	<% switch from = $id_language %>
		<% case value='hu' %><button id="btn_checkout" type="button">Megrendelés</button>
		<% case %><button id="btn_checkout" type="button">Proceed to checkout</button>
	<% /switch %>
</div>
<% else %>
<script type="text/javascript">
