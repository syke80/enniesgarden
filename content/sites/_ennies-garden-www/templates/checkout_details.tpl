...
<div class="content-box">
	<div class="outline">
		...
		<div class="steps">
			<ul class="steps">
				<li class="completed"><span class="order">1</span>Sign In</li>
				<li class="active"><span class="order">2</span>Sign In</li>
				<li><span class="order">3</span>Sign In</li>
				<li><span class="order">4</span>Sign In</li>
			</ul>
		</div>
		...
		<form id="form_details" action="<% $checkout_url %>" method="put">
			<div class="formdiv">
				...
				<div class="item">
					<label for="details_shipping_postcode">Post Code *</label>
				...
				<div class="item">
					<label for="details_billing_same">My billing information is the same as my delivery information</label>
				...
				<div id="billing">
					...
					<div class="item">
						<label for="details_billing_postcode">Post code *</label>
		...
		<% if !$customer %>
				<div class="item">
					<label for="details_register">I want to sign up with this e-mail address</label>
						...
						<% foreach from=$shipping_method_list value='shipping_method' %>
							...
							<div class="radio_item">
								...
								<label for="details_register_shipping_method_<% $shipping_method[id_shipping_method] %>">
									...
									<% if $shipping_method[price] %>( £<% $shipping_method[price] %> )<% /if %>
								</label>
							</div>
							<% /if %>
						<% /foreach %>
